...
To get VS mortality dataset to something that is organized at the county, age, sex race level, we have to do a bunch of dumb shit, or I should
say that I have to do a bunch of dumb shit. Basically, raw data is in separate excel sheets for male and female. Right now, I do the following to get to a clean dataset:
